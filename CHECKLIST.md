# Monad Pay Button — Checklist Monad Blitz Buenos Aires
...
- [ ] Al menos 1 contrato desplegado en Monad testnet (Monad Pay Button.sol)
...
- [ ] 0:15-0:35 Desplegar Monad Pay Button.sol en Remix, copiar address + ABI
